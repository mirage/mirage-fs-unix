...
(* OASIS_START *)
(* DO NOT EDIT (digest: 0836bc4a61d568a6b582c486ed7945da) *)
(*
...
let setup_t =
  {
            ...
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$test_fs_unix", []))];
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Kvro_fs_unix"; "FS_unix"];
                      lib_pack = false;
                      lib_internal_modules = ["Fs_common"];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "mirage-fs-unix";
                      lib_findlib_directory = None;
                      lib_findlib_containers = []
                   });
               Executable
                 ({
                     cs_name = "test_fs_unix";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           InternalLibrary "mirage_fs_unix";
                   ...
                   {exec_custom = true; exec_main_is = "test_fs_unix.ml"});
               Test
                 ({
                     cs_name = "fs_unix";
                     cs_data = PropList.Data.create ();
     ...
     oasis_version = "0.4.7";
     oasis_digest = Some "\128Y\207?\025\209\206\203A\028\183d\253\225\001|";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
